...
"""
# This is NETCONF over SSH code by NAPALM library used to retrive BGP neighbours for Cisco routers, Can be run from windows or Linux machines.
...
# we use driver (get_bgp_neighbors) to get all router information by driver name (iosxr)
...
for host_ip in devices_list:
    ...
    Ciscodevice.open()
    Cisco_output = Ciscodevice.get_bgp_neighbors()
