...
"""
# This is NETCONF over SSH code by NAPALM library used to retrive all information for juniper routers, Can be run from windows or Linux machines.
...
# we use driver (get_facts) to get all router information by driver name (junos)
